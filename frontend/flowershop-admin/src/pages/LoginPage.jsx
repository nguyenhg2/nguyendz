    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg,#1a1a2e,#16213e,#0f3460)' }}>
      <div style={{ background: '#fff', borderRadius: 20, padding: '44px 40px', width: '100%', maxWidth: 420, boxShadow: '0 24px 60px rgba(0,0,0,.35)' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <div style={{ fontWeight: 800, fontSize: 22, color: '#c84b6b' }}>Mộng Lan Admin</div>
          <div style={{ fontSize: 13, color: 'var(--muted)', marginTop: 4 }}>Đăng nhập vào hệ thống quản trị</div>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 20, fontSize: 12, color: 'var(--muted)' }}>
          Chỉ tài khoản có Role = <strong>Admin</strong> mới được truy cập
        </div>
      </div>
    </div>
  );
